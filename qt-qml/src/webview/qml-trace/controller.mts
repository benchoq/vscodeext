...
import {
  ...
  CommandHandler,
  IsCommand
} from '@qtshared/webview/message.js';
import { WebviewChannel } from '@/webview/channel.mts';
import { QmlTraceCommandReply } from '@qtshared/webview/qml-trace.js';
import { QmlTraceDoc } from './doc.mts';
// import * as texts from '@qtshared/webview/texts.js';
...
export class QmlTraceController {
  ...
  private readonly _onSelectFolder = async (cmd: Command) => {
    const options: vscode.OpenDialogOptions = {
      ...
      openLabel: 'Select folder' // texts.qmlTrace.folderSelectTitle
    };
